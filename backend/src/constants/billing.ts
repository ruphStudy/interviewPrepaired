...
export enum BillingErrorCode {
  ...
  // Organization (B2B) billing — PR-B2B-BILL.
  ORGANIZATION_BILLING_NOT_ALLOWED = 'ORGANIZATION_BILLING_NOT_ALLOWED',
  ORGANIZATION_PAYMENT_ORDER_NOT_FOUND = 'ORGANIZATION_PAYMENT_ORDER_NOT_FOUND',
  ORGANIZATION_PLAN_INVALID = 'ORGANIZATION_PLAN_INVALID',
  ORGANIZATION_CREDIT_PLAN_INVALID = 'ORGANIZATION_CREDIT_PLAN_INVALID',
  ORGANIZATION_SUBSCRIPTION_ALREADY_ACTIVE = 'ORGANIZATION_SUBSCRIPTION_ALREADY_ACTIVE',
  ORGANIZATION_PAYMENT_REQUIRED = 'ORGANIZATION_PAYMENT_REQUIRED',
  ORGANIZATION_BILLING_PERMISSION_DENIED = 'ORGANIZATION_BILLING_PERMISSION_DENIED',
